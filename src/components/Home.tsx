...
export const Home: React.FC<Props> = ({}) => {
  ...
  return (
    <div
      className={
        "bg-[#131326] flex justify-center w-screen min-h-screen h-full"
      }
    >
      {loading ? (
        <div className="text-4xl h-screen flex items-center">
          <div role="status">
            <svg
              aria-hidden="true"
        ...
        <div className="w-full py-10 px-8 flex flex-col gap-10">
          <div className="first:pl-10 grid grid-flow-col gap-5 overflow-x-auto h-52">
